 ...
 */
public class TvSitcomLiveTemplate implements ItemViewDelegate<TvChannel> {
    ...
    public void convert(final ViewHolder holder, final TvChannel tvChannel, final int position) {
        ...
        if (TvDataTransform.getClassifyPosition() == tvChannel.classifyPosition
                && TvDataTransform.getKindPosition() == 0 && position == TvDataTransform.getChannelPosition()) {
