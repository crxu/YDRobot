package com.readyidu.robot.ui.adapter.common;
...
import com.readyidu.robot.ui.adapter.common.base.ItemViewDelegateManager;
...
public class MultiItemTypeAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (itemViewDelegate instanceof BaseMessageTemplate){
            holder = ViewHolder.createViewHolderForMessage(mContext, parent, layoutId);
        } else {
