...
//                    classifyPos = divided + offset;
//                    Log.d(TAG, ">down...classifyPos: " + classifyPos);
//                }else if(scrollDirection == SCROLL_DIRECTION_UP){
//                    classifyPos = divided + offset + 1;
//                    Log.d(TAG, ">up...classifyPos: " + classifyPos);
//                }
//            }else{
////                classifyPos = y / itemHeight + offset;
//                if(scrollDirection == SCROLL_DIRECTION_DOWN){
//                    classifyPos = divided + offset;
//                    Log.d(TAG, "<down...classifyPos: " + classifyPos);
//                }else if(scrollDirection == SCROLL_DIRECTION_UP){
...
//            classifyPos = divided + offset + 1;
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(Color.parseColor("#E61D1E1E"));
