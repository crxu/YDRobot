...
public class DeviceUtils {
    ...
    public static String getDeviceId() {
        ...
        try {
            //wifi mac地址
            WifiManager wifi = (WifiManager) YDRobot.getInstance().getContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
        ...
        try {
            //IMEI（imei）
            TelephonyManager tm = (TelephonyManager) YDRobot.getInstance().getContext().getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    private static String getCountry() {
        return YDRobot.getInstance().getContext().getResources().getConfiguration().locale.getCountry();
    }
    ...
    private static String getLanguage() {
        return YDRobot.getInstance().getContext().getResources().getConfiguration().locale.getLanguage();
    }
