 ...
 *
 */
public class LotteryInfoAdapter extends RecyclerView.Adapter<LotteryInfoAdapter.ViewHolder> {
    ...
    public LotteryInfoAdapter(Context context, List<LotteryContent.ResultBean> mData) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.title_tv.setText("第" + category.getIssue() + "期");
        ...
        //        OPENLOG.d(number+"=========asdasdas==="+data);
    }
