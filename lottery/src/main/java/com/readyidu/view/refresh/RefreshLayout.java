...
package com.readyidu.view.refresh;
...
public class RefreshLayout extends LinearLayout {
    private static final String     TAG                                = RefreshLayout.class
            .getSimpleName();
    ...
    private void initWholeHeaderView() {
        ...
        mWholeHeaderView.setLayoutParams(
    ...
    private void initRefreshHeaderView() {
        ...
        if (mRefreshHeaderView != null) {
            mRefreshHeaderView.setLayoutParams(
                    new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
    ...
    public void setCustomHeaderView(View customHeaderView, boolean scrollable) {
        ...
        if (mCustomHeaderView != null) {
            mCustomHeaderView.setLayoutParams(
                    new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
    ...
    private boolean shouldHandleRefresh() {
        if (!mPullDownRefreshEnable || mIsLoadingMore
                || mCurrentRefreshStatus == RefreshStatus.REFRESHING || mRefreshHeaderView == null
                || mDelegate == null) {
            return false;
        }
    ...
    private boolean handleActionMove(MotionEvent event) {
        ...
        if (refreshDiffY > 0 && shouldHandleRefresh() && isCustomHeaderViewCompleteVisible()) {
            ...
            if (paddingTop > 0 && mCurrentRefreshStatus != RefreshStatus.RELEASE_REFRESH) {
                ...
                /**
                 * 往下滑 paddingTop mMinWholeHeaderViewPaddingTop 到 0 scale 0 到 1 往上滑 paddingTop 0
                 * 到 mMinWholeHeaderViewPaddingTop scale 1 到 0
                 */
    ...
    private boolean handleActionUpOrCancel(MotionEvent event) {
        ...
        if ((mCustomHeaderView == null
                || (mCustomHeaderView != null && !mIsCustomHeaderViewScrollable))
        ...
        if (mCurrentRefreshStatus == RefreshStatus.PULL_DOWN
            ...
            if (mCustomHeaderView == null
                    || (mCustomHeaderView != null && mWholeHeaderView.getPaddingTop() < 0
                            && mWholeHeaderView.getPaddingTop() > mMinWholeHeaderViewPaddingTop)) {
    ...
    public void beginLoadingMore() {
        if (!mIsLoadingMore && mLoadMoreFooterView != null && mDelegate != null
                && mDelegate.onRefreshLayoutBeginLoadingMore(this)) {
            mIsLoadingMore = true;
