...
public class TvRecyclerView extends RecyclerView {
    ...
    private void initView() {
        ...
        /**
         * 防止RecyclerView刷新时焦点不错乱bug的步骤如下: (1)adapter执行setHasStableIds(true)方法
         * (2)重写getItemId()方法,让每个view都有各自的id (3)RecyclerView的动画必须去掉
         */
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mSelectedItemCentered = a.getBoolean(R.styleable.TvRecyclerView_tv_selectedItemCentered,
                    false);
            mLoadMoreBeforehandCount = a
                    .getInteger(R.styleable.TvRecyclerView_tv_loadMoreBeforehandCount, 0);
            mSelectedItemOffsetStart = a.getDimensionPixelSize(
                    R.styleable.TvRecyclerView_tv_selectedItemOffsetStart, 0);
            mSelectedItemOffsetEnd = a
                    .getDimensionPixelSize(R.styleable.TvRecyclerView_tv_selectedItemOffsetEnd, 0);
    ...
    /**
     * 设置选中的Item距离开始或结束的偏移量； 与滚动方向有关； 与setSelectedItemAtCentered()方法二选一
     *
     * @param offsetStart
                ...
                switch (event.getKeyCode()) {
                    ...
                    case KeyEvent.KEYCODE_DPAD_DOWN:
                        ...
                        if (downView != null) {
                            ...
                            this.scrollBy(0, dy);
                            View downView2 = FocusFinder.getInstance().findNextFocus(this,
                    ...
                    case KeyEvent.KEYCODE_DPAD_UP:
                        ...
                        if (upView != null) {
                            ...
                            //                            this.smoothScrollBy(0, -dy);
                            this.scrollBy(0, -dy);
                            View upView2 = FocusFinder.getInstance().findNextFocus(this, focusView,
                                    View.FOCUS_UP);
                            if (upView2 != null) {
                                upView2.requestFocus();
                                return true;
                            }
                            return true;
                        }
